...
from parameters import asset4,limit,stoploss,ehour,eminute,shour,sminute,exptime,amount,acc_type,user,passw
...
with open('asset4.csv', mode='a', newline='') as file:
