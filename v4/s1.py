...
from parameters import asset1,limit,stoploss,ehour,eminute,shour,sminute,exptime,amount,acc_type,user,passw
...
with open('asset1.csv', mode='a', newline='') as file:
