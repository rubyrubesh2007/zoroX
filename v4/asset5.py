...
from parameters import asset5,limit,stoploss,ehour,eminute,shour,sminute,exptime,amount,acc_type,user,passw
...
with open('asset5.csv', mode='a', newline='') as file:
