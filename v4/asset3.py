...
from parameters import asset3,limit,stoploss,ehour,eminute,shour,sminute,exptime,amount,acc_type,user,passw
...
with open('asset3.csv', mode='a', newline='') as file:
